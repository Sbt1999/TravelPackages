...
public class TravelPackageTest {
    ...
    public void setUp() {
        ...
        destination = new DestinationBuilder().setName("Bali").createDestination();
    ...
    public void testGetItinerary() {
        ...
        itinerary.add(new DestinationBuilder().setName("Somalia").createDestination());
        itinerary.add(new DestinationBuilder().setName("Delhi").createDestination());
